...
extern layer* build_layer_FC(int output_size, activation* activation);
extern layer* build_layer_Conv2D(int output_channel_size, int kernel_width, int kernel_height, int stride, short padding, activation* activation);
extern layer* build_layer_Flatten();
extern layer* build_layer_MaxPooling2D(int pool_height, int pool_width, int stride);
extern layer* build_layer_Padding2D(int padding_height, int padding_width);
