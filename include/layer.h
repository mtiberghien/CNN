...
typedef struct layer{
    ...
    tensor* (*backward_propagation)(tensor* gradient, tensor* gradient_previous, tensor* input, tensor* activation_input, tensor* output, optimizer* optimizer, struct layer* layer);
